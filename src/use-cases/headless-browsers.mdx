...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m────────[0m [90mdomain[0m: https://nameless-fog-0tvh1uov.fra0.kraft.host
...
In the example run above, the landing page is at the address https://nameless-fog-0tvh1uov.fra0.kraft.host
...
node-express-puppeteer-7afg3  node-express-puppeteer-7afg3.fra0.kraft.host running  since 6mins   node-express-puppeteer-7afg3@s...  4.0 GiB  /usr/bin/wrapper.sh /usr/bin/n...  15.27 ms
```
