...
[service](/docs/platform/services) for it via the `-p` flag, and mount the `my-volume` volume at `/mnt`:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m───────────[0m [90murl[0m: https://holy-bonobo-px345skl.fra0.kraft.host
...
```bash title=""
$ curl https://holy-bonobo-px345skl.fra0.kraft.host
Log file created.
2024-02-24 08:15:32
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─────────[0m [90mstate[0m: [92mrunning[0m
 [90m├[0m[90m───────────[0m [90murl[0m: https://winter-field-v6m37jgs.fra0.kraft.host
...
* The `kraft cloud` [CLI reference](/docs/cli/), in particular the [deploy](/docs/cli/deploy) and [volumes](/docs/cli/volume) subcommands
* Unikraft Cloud's [REST API reference](/docs/api/v1), in particular the section on [volumes](/docs/api/v1/volumes)
