...
Autoscaling is [load balancing](/docs/features/load-balancing) where the *number of instances* used to handle your traffic is automatically adapted to match the current traffic load.
...
As with [load balancing](/docs/features/load-balancing), autoscaling in Unikraft Cloud takes care of a *service*.
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m───────────[0m [90murl[0m: https://small-leaf-rafirkw7.fra0.kraft.host
...
Refer to the API autoscale [reference](/docs/api/v1/autoscale/#step) for more details.
...
The documentation is available [here](/docs/api/v1/autoscale/#step) at the bottom of the section.
General information about autoscale is available [here](/docs/api/v1/autoscale)
...
* The `kraft cloud` [command-line tool reference](/docs/cli/), and in particular the [scale](/docs/cli/scale) subcommand.
* Unikraft Cloud's [REST API reference](/docs/api/v1), and in particular the section on [autoscale](/docs/api/v1/autoscale).
