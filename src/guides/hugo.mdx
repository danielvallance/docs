...
hugo-zpabu     morning-rain-jikpfy3t.fra0.kra...  running  1 minute ago   hugo@sha256:68d20fdb707076b1cd0f2848b17cc75670d8a...  512 MiB    /usr/bin/hugo server --bind=...      77166us
```
