...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m───────────[0m [90murl[0m: https://aged-waterfall-qraz0s7d.dal0.kraft.host
...
In this case, the instance name is `ruby32-rails-apa93` and the address is `https://aged-waterfall-qraz0s7d.dal0.kraft.host`.
