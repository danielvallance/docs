...
The annotation pairs with an [interface without an address](/features/custom-network-configuration#interfaces-without-an-address), which the platform hands to the guest as a bare link.
