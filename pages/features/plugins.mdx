...
Plugins are a new feature that **is not** enabled by default and requires a valid license.
If you would like to try it out, please reach out to the [Unikraft Cloud Discord](https://kraft.cloud/discord) or send an email to [support@unikraft.com](mailto:support@unikraft.com).
:::
{/* vale on */}
