...
An interface that carries a `tap_name` but no `ip` hands you the link without an address on it:
...
The platform provides the link, and your side decides what runs on it.
