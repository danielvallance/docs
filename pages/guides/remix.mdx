...
```bash title="unikraft"
unikraft build . --output my-org/node21-remix:latest
unikraft run --metro=fra -p 443:3000/http+tls -m 512MiB my-org/node21-remix:latest
```
...
```bash title="unikraft"
unikraft instances delete node21-remix-jvj6b
```
