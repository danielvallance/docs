...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: oci://unikraft.io/<my-org>/duckdb-go121@sha256:6999293f8694ac00beb6a1d639fab8f96f78c2e6ecb8ccb2311539908895a699
...
fra    duckdb-go121-qfd8x  [92mrunning[0m  <my-org>/duckdb-go121        256MiB  1      autumn-gorilla-hg4h6sup.fra.unikraft.app  2 minutes ago
```

```ansi title="kraft"
[1mNAME[0m                [1mFQDN[0m                                      [1mSTATE[0m    [1mSTATUS[0m        [1mIMAGE[0m                                               [1mMEMORY[0m   [1mVCPUS[0m  [1mARGS[0m  [1mBOOT TIME[0m
duckdb-go121-qfd8x  autumn-gorilla-hg4h6sup.fra.unikraft.app  [92mrunning[0m  1 minute ago  oci://unikraft.io/<my-org>/duckdb-go121@sha256:...  256 MiB  1            32.12 ms
```
