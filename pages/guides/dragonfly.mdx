...
1. Clone the [`examples` repository](https://github.com/kraftcloud/examples) and `cd` into the `examples/dragonflydb/` directory:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m──────────[0m [90mname[0m: dragonflydb-10zgk
 [90m├[0m[90m──────────[0m [90muuid[0m: 6282ef0c-2161-494c-a3f3-2d16055096c2
 [90m├[0m[90m─────────[0m [90mstate[0m: [92mrunning[0m
 [90m├[0m[90m───────────[0m [90murl[0m: https://dry-moon-x6bgl6c0.fra.unikraft.app
 [90m├[0m[90m─────────[0m [90mimage[0m: dragonflydb@sha256:21e6d3ff1f86292e14266bcf5c6e73d3b7a86a0ec4102c66a0961373af743f19
 [90m├[0m[90m─────[0m [90mboot time[0m: 28.74 ms
 [90m├[0m[90m────────[0m [90mmemory[0m: 512 MiB
 [90m├[0m[90m───────[0m [90mservice[0m: dry-moon-x6bgl6c0
 [90m├[0m[90m──[0m [90mprivate fqdn[0m: dragonflydb-10zgk.internal
 [90m├[0m[90m────[0m [90mprivate ip[0m: 172.16.6.5
 [90m└[0m[90m──────────[0m [90margs[0m: /usr/bin/dragonfly --maxmemory 256MiB
```
...
dragonflydb-10zgk  dry-moon-x6bgl6c0.fra.unikraft.app  running  1 minute ago  dragonflydb@sha256:21e6d3...     512 MiB  /usr/bin/dragonfly --maxmemor...         28740us
```
