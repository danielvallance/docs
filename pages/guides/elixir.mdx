...
```bash title="unikraft"
unikraft build . --output my-org/http-elixir116:latest
unikraft run --metro=fra -p 443:3000/http+tls -m 1024MiB my-org/http-elixir116:latest
```
...
```bash title="unikraft"
unikraft instances delete elixir-qo9k3
```
