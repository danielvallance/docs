...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m────────[0m [90mdomain[0m: https://small-water-tl8lr8am.fra.unikraft.app
...
elixir-qo9k3  small-water-tl8lr8am.fra.unikraft.app  running  since 9mins  sha256:67f5df0...  1.0 GiB  /usr/bin/wrapper.sh /usr/local/bin/mix r...  437.43 ms
```
