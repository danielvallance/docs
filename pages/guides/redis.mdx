...
```bash title="unikraft"
unikraft build . --output my-org/redis:latest
unikraft run --metro=fra -p 6379:6379/tls -m 512MiB my-org/redis:latest
```
...
redis-alb4r  rough-wind-8vxrd1ms.fra.unikraft.app  running  1 minute ago  redis@sha256:9665c5...  512 MiB  /usr/bin/redis-server /etc/red...  26131us
```
