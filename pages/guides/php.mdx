...
```bash title="unikraft"
unikraft build . --output my-org/http-php82:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 128MiB my-org/http-php82:latest
```
...
```bash title="unikraft"
unikraft instances delete http-php82-g00si
```
