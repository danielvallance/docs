...
1. Clone the [`examples` repository](https://github.com/kraftcloud/examples) and `cd` into the `examples/mongodb/` directory:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m──────────[0m [90mname[0m: mongodb-6tiuu
 [90m├[0m[90m──────────[0m [90muuid[0m: 99779597-0bdb-4160-b902-a160c3ab4b2a
 [90m├[0m[90m─────────[0m [90mstate[0m: [92mrunning[0m
 [90m├[0m[90m──────────[0m [90mfqdn[0m: bold-brook-khkwv7of.fra.unikraft.app
 [90m├[0m[90m─────────[0m [90mimage[0m: mongodb@sha256:e6ff5153f106e2d5e2a10881818cd1b90fe3ff1294ad80879b2239ffc52aff0e
 [90m├[0m[90m─────[0m [90mboot time[0m: 82.41 ms
 [90m├[0m[90m────────[0m [90mmemory[0m: 1024 MiB
 [90m├[0m[90m───────[0m [90mservice[0m: bold-brook-khkwv7of
 [90m├[0m[90m──[0m [90mprivate fqdn[0m: mongodb-6tiuu.internal
 [90m├[0m[90m────[0m [90mprivate ip[0m: 172.16.6.4
 [90m└[0m[90m──────────[0m [90margs[0m: /usr/bin/mongod --bind_ip_all --nounixsocket
```
...
mongodb-6tiuu  bold-brook-khkwv7of.fra.unikraft.app  running  20 minutes ago  mongodb@sha256:e6ff5153f106e2...   1.0 GiB  /usr/bin/mongod --bind_ip_all...  82410us
```
