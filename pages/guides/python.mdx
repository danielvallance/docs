...
1. Clone the [`examples` repository](https://github.com/kraftcloud/examples) and `cd` into the `examples/http-python3.12/` directory:
...
unikraft run --metro=fra -p 443:8080/http+tls -m 512MiB my-org/http-python312:latest
```
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─────────[0m [90mimage[0m: http-python312@sha256:278cb8b14f9faf9c2702dddd8bfb6124912d82c11b4a2c6590b6e32fc4049472
...
```bash title="unikraft"
unikraft instances delete http-python312-ma2i9
```
...
```bash title="unikraft"
unikraft build . --output my-org/http-python312-flask:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 512MiB my-org/http-python312-flask:latest
```
