...
httpserver-erlang26.2-sw2bp  patient-field-ck629jsu.fra.unikraft.app  [92mrunning[0m  since 35secs  httpserver-erlang26.2@sha256:4372...  512 MiB  1      /usr/bin/wrapper.sh /usr/bin/erl ...  404.04 ms
```
