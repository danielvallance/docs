...
```bash title="unikraft"
unikraft build . --output my-org/http-cpp:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 128MiB my-org/http-cpp:latest
```
...
```bash title="unikraft"
unikraft instances delete http-cpp-jzbuo
```
