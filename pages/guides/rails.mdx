...
1. Clone the [`examples` repository](https://github.com/kraftcloud/examples) and `cd` into the `examples/ruby3.2-rails/` directory:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m──────────[0m [90mname[0m: ruby32-rails-apa93
 [90m├[0m[90m──────────[0m [90muuid[0m: 2f85b9db-94f8-45d2-8e38-ed9b56cb8695
 [90m├[0m[90m─────────[0m [90mstate[0m: [92mrunning[0m
 [90m├[0m[90m───────────[0m [90murl[0m: https://aged-waterfall-qraz0s7d.fra.unikraft.app
 [90m├[0m[90m─────────[0m [90mimage[0m: ruby32-rails@sha256:fdd46011408fdee05644665ad59b24115737e3fdb352169ec2f3f16a45d4f31d
 [90m├[0m[90m─────[0m [90mboot time[0m: 577.34 ms
 [90m├[0m[90m────────[0m [90mmemory[0m: 1024 MiB
 [90m├[0m[90m───────[0m [90mservice[0m: aged-waterfall-qraz0s7d
 [90m├[0m[90m──[0m [90mprivate fqdn[0m: ruby32-rails-apa93.internal
 [90m├[0m[90m────[0m [90mprivate ip[0m: 172.16.3.3
 [90m└[0m[90m──────────[0m [90margs[0m: /usr/bin/ruby /app/bin/rails server -b 0.0.0.0
```
...
ruby32-rails-apa93  aged-waterfall-qraz0s7d.fra.unikraft.app  running  2 minutes ago  ruby32-rails@sha256:fdd46011408fdee...  1.0 GiB  /usr/bin/ruby /app/bin/rails server -b 0.0.0.0  577.34 ms
```
