...
```bash title="unikraft"
unikraft build . --output my-org/http-rust175-tokio:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 128MiB my-org/http-rust175-tokio:latest
```
...
```bash title="unikraft"
unikraft instances delete http-rust175-tokio-6gxsp
```
