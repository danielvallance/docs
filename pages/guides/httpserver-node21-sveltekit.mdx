...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mname[0m: httpserver-node21-sveltekit-zmt39
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: oci://unikraft.io/<my-org>/httpserver-node21-sveltekit@sha256:4cea210aef3513bd68490640b511ebcff2b867e9222028b9938faccffc21cb83
 ...
 [90m├[0m[90m─[0m [90mprivate fqdn[0m: httpserver-node21-sveltekit-zmt39.internal
...
fra    httpserver-node21-sveltekit-zmt39  [92mrunning[0m  <my-org>/httpserver-node21-sveltekit        512MiB  1      dark-fog-z18n0ej1.fra.unikraft.app  2 minutes ago
```

```ansi title="kraft"
[1mNAME[0m                               [1mFQDN[0m                                [1mSTATE[0m    [1mSTATUS[0m         [1mIMAGE[0m                                                              [1mMEMORY[0m   [1mVCPUS[0m  [1mARGS[0m  [1mBOOT TIME[0m
httpserver-node21-sveltekit-zmt39  dark-fog-z18n0ej1.fra.unikraft.app  [92mrunning[0m  5 minutes ago  oci://unikraft.io/<my-org>/httpserver-node21-sveltekit@sha256:...  512 MiB  1            72.86 ms
```
