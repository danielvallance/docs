...
Make sure to log into Unikraft Cloud and pick a [metro](/docs/metros#available) close to you.
...
unikraft run --metro=fra -p 443:8080/http+tls -m 128MiB my-org/http-go121:latest
```
...
```bash title="unikraft"
unikraft instances delete http-go121-9a2wv
```
