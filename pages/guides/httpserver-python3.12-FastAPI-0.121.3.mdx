...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mname[0m: httpserver-python312-fastapi-01213-0n84f
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90muuid[0m: 5d7fc331-3c23-4953-b025-d152a872ea29
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mdomain[0m: https://dry-water-0oexx89g.fra.unikraft.app
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: httpserver-python312-fastapi-01213@sha256:fb2a00dcf1cfc3ac821cbda05f82f38d66e63121344b9bc60c6a6e2f11917b98
 [90m├[0m[90m─[0m [90mboot time[0m: 170.42 ms
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mmemory[0m: 512 MiB
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m [90mservice[0m: dry-water-0oexx89g
 [90m├[0m [90mprivate ip[0m: 10.0.1.69
 [90m└[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90margs[0m: /usr/bin/python3 -m uvicorn src.server:app --host 0.0.0.0 --port 8080
```
...
httpserver-python312-fastapi-01213-0n84f  dry-water-0oexx89g.fra.unikraft.app  [94mstandby[0m  standby  httpserver-python312-fastapi-01213@sha25...  512 MiB  1      /usr/bin/python3 -m uvicorn src.server:app --hos...  169.45 ms
```
