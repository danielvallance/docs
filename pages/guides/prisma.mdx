...
1. Clone the [`examples` repository](https://github.com/kraftcloud/examples) and `cd` into the `examples/node18-prisma-rest-express/` directory:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m──────────[0m [90mname[0m: node18-prisma-hdof1
 [90m├[0m[90m──────────[0m [90muuid[0m: 066f55cb-bcbd-45e5-9f6b-b3866c3a3a4c
 [90m├[0m[90m─────────[0m [90mstate[0m: [92mrunning[0m
 [90m├[0m[90m───────────[0m [90murl[0m: https://funky-sun-4bf8v7g9.fra.unikraft.app
 [90m├[0m[90m─────────[0m [90mimage[0m: node18-prisma@sha256:770d4af1d490daea11171c680eaf99e2a6017a262ba9fbf1ba8d708f5fc32bfe
 [90m├[0m[90m─────[0m [90mboot time[0m: 37.94 ms
 [90m├[0m[90m────────[0m [90mmemory[0m: 512 MiB
 [90m├[0m[90m───────[0m [90mservice[0m: funky-sun-4bf8v7g9
 [90m├[0m[90m──[0m [90mprivate fqdn[0m: node18-prisma-hdof1.internal
...
node18-prisma-hdof1   funky-sun-4bf8v7g9.fra.unikraft.app    running  1 minute ago  node18-prisma@sha25...  512 MiB  /usr/bin/node /usr/src/server.js  37935us
```
...
If you would like to test the server locally before deploying to Unikraft Cloud, follow the instructions [here](https://github.com/kraftcloud/examples/tree/main/node18-prisma-rest-express).
