...
```bash title="unikraft"
unikraft build . --output my-org/http-rust175-actix-web4:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 128MiB my-org/http-rust175-actix-web4:latest
```
...
```bash title="unikraft"
unikraft instances delete http-rust175-actix-web4-3pj27
```
