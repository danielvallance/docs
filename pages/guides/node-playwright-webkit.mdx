---
title: "Playwright (WebKit) with Node.js"
---
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: oci://unikraft.io/<my-org>/node-playwright-webkit@sha256:9e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f
...
fra    node-playwright-webkit-t7r2j  [92mrunning[0m  <my-org>/node-playwright-webkit        4096MiB  1      silent-fog-er8np3fb.fra.unikraft.app  2 minutes ago
```

```ansi title="kraft"
[1mNAME[0m                          [1mFQDN[0m                                  [1mSTATE[0m    [1mSTATUS[0m        [1mIMAGE[0m                                                         [1mMEMORY[0m  [1mVCPUS[0m  [1mARGS[0m  [1mBOOT TIME[0m
node-playwright-webkit-t7r2j  silent-fog-er8np3fb.fra.unikraft.app  [92mrunning[0m  1 minute ago  oci://unikraft.io/<my-org>/node-playwright-webkit@sha256:...  4 GiB   1            2.94 s
```
