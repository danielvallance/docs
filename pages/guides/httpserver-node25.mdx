...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mname[0m: httpserver-node25-v8mp4
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: oci://unikraft.io/<my-org>/httpserver-node25@sha256:7b3e1f9d5a2c8e4b0f6d3a7c5e2b9f4d1a8c6e3b0f7d4a1c8e5b2f9d6a3c0
 ...
 [90m├[0m[90m─[0m [90mprivate fqdn[0m: httpserver-node25-v8mp4.internal
...
fra    httpserver-node25-v8mp4  [92mrunning[0m  <my-org>/httpserver-node25        512MiB  1      bright-star-k3m7pqnx.fra.unikraft.app  2 minutes ago
```

```ansi title="kraft"
[1mNAME[0m                     [1mFQDN[0m                                   [1mSTATE[0m    [1mSTATUS[0m       [1mIMAGE[0m                                                    [1mMEMORY[0m   [1mVCPUS[0m  [1mARGS[0m  [1mBOOT TIME[0m
httpserver-node25-v8mp4  bright-star-k3m7pqnx.fra.unikraft.app  [92mrunning[0m  since 3mins  oci://unikraft.io/<my-org>/httpserver-node25@sha256:...  512 MiB  1            276.18 ms
```
