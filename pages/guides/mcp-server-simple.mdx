...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 [90m│[0m
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mname[0m: mcp-server-simple-bbdcb
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90muuid[0m: e87d3591-3497-4f30-bd76-1dc886059647
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mdomain[0m: https://cool-paper-b6mht7jv.fra.unikraft.app
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mimage[0m: mcp-server-simple@sha256:cbbfb441ee313a6c7c0de571e9002f0f6031312e203ffb6be3b8f4950df3bc20
 [90m├[0m[90m─[0m [90mboot time[0m: 145.96 ms
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mmemory[0m: 512 MiB
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m [90mservice[0m: cool-paper-b6mht7jv
 [90m├[0m [90mprivate ip[0m: 10.0.0.193
 [90m└[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90margs[0m: /usr/bin/python3 /src/server.py
```
...
mcp-server-simple-bbdcb  cool-paper-b6mht7jv.fra.unikraft.app  [94mstandby[0m  standby  mcp-server-simple@sha256:cbbfb441ee313a6c7c0de5...  512 MiB  1      /usr/bin/python3 /src/server.py  9.15 ms
```
