...
When no running or stopped instance references an image, the agent garbage-collects it to reclaim space.
If you need the image again later, the agent pulls it on demand from the registry.
