...
To read more about Scale To Zero, check the [Scale To Zero](/features/scale-to-zero) page.
...
You can use the [`kraft` CLI tool](/cli/) or the [API](/api/platform/v1/instances#create-instance) to enable this trigger:
...
You can enable this trigger using the [`kraft` CLI tool](/cli/) or the [API](/api/platform/v1/instances#create-instance) as follows:
