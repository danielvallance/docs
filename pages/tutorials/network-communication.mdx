...
:::note
When using [`kraft cloud tunnel`](/cli/tunnel) to connect to your instances you are using the internal network to reach your instance.
...
* The `kraft cloud` [command-line tool reference](/cli/), and in particular the [tunnel](/cli/tunnel) subcommand.
