...
fra    tyk-s9ixd    [94mstandby[0m <my-org>/tyk    256MiB  1      icy-haze-8ph4u8cz.fra.unikraft.app  just now
fra    redis-6vgvc  [92mrunning[0m <my-org>/redis  256MiB  1      tyk-redis.internal                  1 minute ago
```
