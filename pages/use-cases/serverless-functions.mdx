...
fra    node-exec  [94mtemplate[0m  acioc/node-code-exec        512MiB  1      just now
```

```ansi title="kraft"
[1mNAME[0m       [1mIMAGE[0m                                                                                                           [1mARGS[0m  [1mCREATED AT[0m
node-exec  oci://unikraft.io/acioc/node-code-exec@sha256:71487fd6196987cf65fb89eb84405cb796677aba177dabacf391f09618313328        20 seconds ago
```
