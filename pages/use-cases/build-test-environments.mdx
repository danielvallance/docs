...
fra    go-build-env  [94mtemplate[0m  acioc/go-build-env        512MiB  1      just now
```

```ansi title="kraft"
[1mNAME[0m          [1mIMAGE[0m                                                                                                     [1mARGS[0m  [1mCREATED AT[0m
go-build-env  oci://unikraft.io/acioc/go-build-env@sha256:1cbd6474386c9df546820cd0522030a1bd8702c59490548f10ae10fb8b0a6e14         20 seconds ago
```
...
fra    go-build-rom2   [94mstandby[0m  acioc/go-build-env        512MiB  1      nameless-wood-gw7pbnls.fra0-sandbox.unikraft.app   2 minutes ago
fra    go-build-rom1   [94mstandby[0m  acioc/go-build-env        512MiB  1      sparkling-dawn-syowlbtj.fra0-sandbox.unikraft.app  3 minutes ago
```

```ansi title="kraft"
[1mNAME[0m            [1mFQDN[0m                                               [1mSTATE[0m    [1mSTATUS[0m   [1mIMAGE[0m                                                  [1mMEMORY[0m   [1mVCPUS[0m  [1mARGS[0m  [1mBOOT TIME[0m
go-build-rom2   nameless-wood-gw7pbnls.fra0-sandbox.unikraft.app   [94mstandby[0m  standby  oci://unikraft.io/acioc/go-build-env@sha256:1cbd64...  512 MiB  1            6.98 ms
go-build-rom1   sparkling-dawn-syowlbtj.fra0-sandbox.unikraft.app  [94mstandby[0m  standby  oci://unikraft.io/acioc/go-build-env@sha256:1cbd64...  512 MiB  1            7.86 ms
```
