...
To start, create the volume via [`kraft cloud volume`](/cli/kraft/volume), with size in MBs and name `my-volume`:
...
If you'd like to populate your empty volume with local data, you can use the [`kraft cloud volume import`](/cli/kraft/volume/import) command.
...
[90m[[0m[92m●[0m[90m][0m Import complete
 ...
 [90m├[0m[90m───[0m [90mfree[0m: 99 MiB
 [90m└[0m[90m──[0m [90mtotal[0m: 100 MiB
```
...
Volume templates have their own create, read, update, and delete endpoints at [`/v1/volumes/templates`](/api/v1/volumes#create-template-volumes).
...
To clone one or more volumes, you can use the [`POST /v1/volumes/clone`](/api/v1/volumes#clone-volumes) endpoint.
