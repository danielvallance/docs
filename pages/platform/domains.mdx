...
You can check the validation status of the certificate with the CLI (more on this command below).
...
unikraft run --metro=fra -p 443:8080/http+tls --domain mydomain.com my-org/nginx:latest
```
