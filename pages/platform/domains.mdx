...
Log into Unikraft Cloud by setting your token and a [metro](/platform/metros) close to you.
...
* The `kraft cloud` [CLI reference](/cli/), in particular the [deploy](/cli/deploy) and [instance](/cli/instance) subcommands
