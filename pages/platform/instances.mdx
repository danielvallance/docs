...
fra    httpserver-go121-taud8  template  <my-org>/httpserver-go121        256MiB  1      6 days ago
```
...
metro:           fra
name:            httpserver-go121-clone
uuid:            91796fdb-bd41-4c7b-856f-9e60356c96bd
state:           standby
image:           acioc/httpserver-go121
resources:
  memory:        256MiB
  vcpus:         1
networks:
- uuid:          8c778b8b-6ede-4e87-a825-159a2269fd19
