...
:::caution
You can currently only view metrics via the [API](/api/platform/v1/instances#get-instances-metrics).
:::
...
```bash title="unikraft"
# not yet supported, use `unikraft api` instead
unikraft api /v1/instances/metrics?uuid=f31c1fa8-6188-4ebe-b6e0-b2de063ad7ea -X GET --metro fra -H "Accept: text/plain"
```
