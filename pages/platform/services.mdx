...
For example, you can configure a service to terminate TLS connections, redirect HTTP traffic, or enable HTTP mode for load balancing.
...
<Tabs defaultValue="tls">
  ...
  <TabsContent value="http">
    ...
    In this mode, only HTTP connections are accepted.
    If this option is not set, the load balancer works in TCP mode and distributes TCP connections.
  </TabsContent>
