...
service:
  ...
  name:       nameless-fog-0tvh1uov                     # <---- service name
  domains:
  - fqdn:     nameless-fog-0tvh1uov.fra.unikraft.app    # <---- service domain
networks:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mdomain[0m: https://nameless-fog-0tvh1uov.fra.unikraft.app    # <---- service domain
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mservice[0m: nameless-fog-0tvh1uov                             # <---- service name
...
metro:         fra
name:          my-service
uuid:          9bfe76ea-2679-482a-954e-577de7d122b3
persistent:    true
limits:
  soft:        1
  hard:        65535
timestamps:
  created:     just now
domains:
- fqdn:        my-service-pc4xjplc.fra.unikraft.app
services:
- source:      443
  destination: 8080
  handlers:    ["tls", "http"]
...
service:
  ...
  name:       my-service
  domains:
  - fqdn:     my-service-f4744h0c.fra.unikraft.app
networks:
...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mmetro[0m: https://api.fra.unikraft.cloud/v1
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mstate[0m: [92mstarting[0m
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mdomain[0m: https://my-service-f4744h0c.fra.unikraft.app
 ...
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mmemory[0m: 256 MiB
 [90m├[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m[90m─[0m [90mservice[0m: my-service
