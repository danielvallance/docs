...
[90m[[0m[92m●[0m[90m][0m Deployed successfully!
 ...
 [90m├[0m[90m─[0m [90mprivate fqdn[0m: httpserver-python312-lscmn.internal
...
httpserver-python312-7lha2  hidden-silence-l3g520dw.fra.unikraft.app      running  since 7mins  <my-org>/httpserver-python312@sh...  512 MiB  1            82.28 ms
httpserver-python312-xfgvc  icy-violet-hce1qwm5.fra.unikraft.app          running  since 7mins  <my-org>/httpserver-python312@sh...  512 MiB  1            81.27 ms
httpserver-python312-lscmn  restless-orangutan-1lklj6z5.fra.unikraft.app  running  since 7mins  <my-org>/httpserver-python312@sh...  512 MiB  1            84.28 ms
```
