...
Next, it starts a empty filesystem called scratch.
...
:::note
It's impossible to remove images from the local registry using the CLI yet.
:::
:::note
...
Returns all images accessible for your account and known by the platform from both the local and central registries.
