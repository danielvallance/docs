...
cd examples/http-python3.12
unikraft build . --output my-org/http-python312:latest
unikraft run --metro=fra -p 443:8080/http+tls -m 512MiB --replicas 2 my-org/http-python312:latest
```
...
```bash title="unikraft"
unikraft run --metro=fra -p 443:8080/http+tls -m 512MiB [username]/http-python312@sha256:1b815914eb568a06ca4bbfdfb7d6cf484a9e9a0947ba8e0e0f1664d972a25bca
```
...
* The legacy [CLI reference](/docs/cli/kraft/overview)
