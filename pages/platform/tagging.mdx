...
:::note
Use `/v1/volumes` for volumes, `/v1/instances/templates` for instance templates, and `/v1/volumes/templates` for volume templates.
:::
...
```
GET /v1/instances?tags=production,customer_A
```
